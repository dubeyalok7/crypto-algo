...
#ifdef USE_32_BIT_ONLY

/* Define shift, rotate left, and rotate rght functions. */
...
static uint32_t ADDTO4_tmp, ADDTO4_tmp2;
#define SHA512_ADDTO4(word1, word2) (                              \
        ADDTO4_tmp = (word1)[3],                                   \
        (word1)[3] += (word1)[3],                                  \
        ADDTO4_tmp2 = (word1)[2],                                  \
        (word1)[2] += (word2)[2] + ((word1)[3] < ADDTO4_tmp),      \
        ADDTO4_tmp = (word1)[1],                                   \
        (word1)[1] += (word2)[1] + ((word1)[2] < ADDTO4_tmp2),     \
        (word1)[0] += (word2)[0] + ((word1)[1] < ADDTO4_tmp))

/* Add the 2word value in word2 to word1.   */
static uint32_t ADDTO2_tmp;
#define SHA512_ADDTO2(word1, word2) (                              \
        ADDTO2_tmp = (word1)[1],                                   \
        (word1)[1] += (word2)[1],                                  \
        (word1)[0] += (word2)[0] + ((word1)[1] < ADDTO2_tmp))

/* SHA roate ((word >> bits) | (word << (64-bits))) */
static uint32_t ROTR_tmp1[2], ROTR_tmp2[2];
#define SHA512_ROTR(bits, word, ret) (                             \
        SHA512_SHR((bits), (word), ROTR_tmp1),                     \
        SHA512_SHL(64 - (bits), (word), ROTR_tmp2),                \
        SHA512_OR(ROTR_tmp1, ROTR_tmp2, (ret)))

/*
 * Define the SHA SIGMA and sigma macros
 * SHA512_ROTR(28, word) ^ SHA512_ROTR(34, word) ^ SHA512_ROTR(39, word)
 */
static uint32_t SIGMA0_tmp1[2], SIGMA0_tmp2[2], SIGMA0_tmp3[2], SIGMA0_tmp4[2];
#define SHA512_SIGMA0(word, ret) (                                 \
        SHA512_ROTR(28, (word), SIGMA0_tmp1),                      \
        SHA512_ROTR(34, (word), SIGMA0_tmp2),                      \
        SHA512_ROTR(39, (word), SIGMA0_tmp3),                      \
        SHA512_XOR(SIGMA0_tmp2, SIGMA0_tmp3, SIGMA0_tmp4),         \
        SHA512_XOR(SIGMA0_tmp1, SIGMA0_tmp4, (ret)))

/* SHA512_ROTR(14, word) ^ SHA512_ROTR(18, word) ^ SHA512_ROTR(41, word) */
static uint32_t SIGMA1_tmp1[2], SIGMA1_tmp2[2], SIGMA1_tmp3[2], SIGMA1_tmp4[2];
#define SHA512_SIGMA1(word, ret) (                                 \
        SHA512_ROTR(14, (word), SIGMA1_tmp1),                      \
        SHA512_ROTR(18, (word), SIGMA1_tmp2),                      \
        SHA512_ROTR(41, (word), SIGMA1_tmp3),                      \
        SHA512_XOR(SIGMA1_tmp2, SIGMA1_tmp3, SIGMA1_tmp4),         \
        SHA512_XOR(SIGMA1_tmp1, SIGMA1_tmp4, (ret)))

/* SHA512_ROTR(1, word) ^ SHA512_ROTR(8, word) ^ SHA512_SHR(7, word) */
static uint32_t sigma0_tmp1[2], sigma0_tmp2[2], sigma0_tmp3[2], sigma0_tmp4[2];
#define SHA512_sigma0(word, ret) (                                 \
        SHA512_ROTR(1, (word), sigma0_tmp1),                       \
        SHA512_ROTR(8, (word), sigma0_tmp2),                       \
        SHA512_SHR(7, (word), sigma0_tmp3),                        \
        SHA512_XOR(sigma0_tmp2, sigma0_tmp3, sigma0_tmp4),         \
        SHA512_XOR(sigma0_tmp1, sigma0_tmp4, (ret)) )
...
static uint32_t sigma1_tmp1[2], sigma1_tmp2[2], sigma1_tmp3[2], sigma1_tmp4[2];
#define SHA512_sigma1(word, ret) (                                 \
        SHA512_ROTR(19, (word), sigma1_tmp1),                      \
        SHA512_ROTR(61, (word), sigma1_tmp2),                      \
        SHA512_SHR(6, (word), sigma1_tmp3),                        \
        SHA512_XOR(sigma1_tmp2, sigma1_tmp3, sigma1_tmp4),        \
        SHA512_XOR(sigma1_tmp1, sigma1_tmp4, (ret)))
...
/*
 * These definitions are the ones used in FIPS 180-3, secition 4.1.3
 * Ch(x, y, z) ((x&y)^(~x & z))
 */
static uint32_t Ch_tmp1[2], Ch_tmp2[2], Ch_tmp3[2], Ch_tmp4[2];
#define SHA_Ch(x, y, z, ret) (                                      \
        SHA512_AND(x, y, Ch_tmp1),                                  \
        SHA512_TILDA(x, Ch_tmp2),                                   \
        SHA512_AND(Ch_tmp2, z, Ch_tmp3),                            \
        SHA512_XOR(Ch_tmp1, Ch_tmp3, (ret)))

/*
 * Maj(x, y, z) (((x)&(y)) ^ ((x)&(z)) ^ ((y)&(z))
 */
static uint32_t Maj_tmp1[2], Maj_tmp2[2], Maj_tmp3[2], Maj_tmp4[2];
#define SHA_Maj(x, y, z, ret) (                                     \
        SHA512_AND(x, y, Maj_tmp1),                                 \
        SHA512_AND(x, z, Maj_tmp2),                                 \
        SHA512_AND(y, z, Maj_tmp3),                                 \
        SHA512_XOR(Maj_tmp2, Maj_tmp3, Maj_tmp4),                   \
        SHA512_XOR(Maj_tmp1, Maj_tmp4, (ret)) )
...
static uint32_t addTmp[4] = {0, 0, 0, 0};
#define SHA384_512AddLength(context, length) (                      \
        addTmp[3] = (length), SHA512_ADDTO4((context)->Length, addTmp), \
...
static void SHA3884_512PadMessage(SHA512Context *context, uint8_t pad_byte);
static void SHA384_512ResultN(SHA512Context *context, uint8_t Message_Digest[], int HashSize);
...
#define SHA51_SHR(bits, word) (((uint64_t)(word)) >> (bits))
...
#define SHA512_SIGMA1(word)     \
    (SHA512_ROTR(14, word) ^ SHA512_ROTR(18, word) ^ SHA512_ROTR(41, word))
#define SHA512_sigma0(word)     \
    (SHA512_ROTR( 1, word) ^ SHA512_ROTR( 8, word) ^ SHA512_ROTR( 7, word))
#define SHA512_sigma1(word)     \
    (SHA512_ROTR(19, word) ^ SHA512_ROTR(61, word) ^ SHA512_ROTR( 6, word))
...
static uint64_t addTmp;
#define SHA384_512AddLength(context, length)                    \
    (addTmp = context->Length_Low, context->Corrupted =         \
...
static void SHA384_512ProcessMessageBlock(SHA512Context *context)
{
    ...
    uint32_t tmp1[2], tmp2[2], tmp3[2], tmp4[2]; /* temporary word values */
